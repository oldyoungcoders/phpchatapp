            ...
            if(isset($_FILES['image'])){
                ...
                if(in_array($img_ext, $extensions) === true){
                    ...
                    if(in_array($img_type, $types) === true){
                        ...
                        // Ensure the new image name includes the extension
                        ...
                        if(move_uploaded_file($tmp_name, "images/".$new_img_name)){
                            ...
                            // Modified to use 'img' as the column name
                    ...
                    echo "Invalid file extension. Please upload an image file - jpeg, png, jpg.";
